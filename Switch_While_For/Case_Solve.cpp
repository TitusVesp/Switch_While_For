...
void  Case5()
{
	cout << "Case5.Арифметические действия над числами пронумерованы следующим\n\
...
void  Case10()
{
	cout << "Case10.Робот может перемещаться в четырех направлениях(«С» — север,\n\
...
void  Case15()
{
	cout << "Case15.Мастям игральных карт присвоены порядковые номера : 1 — пики,\n\
...
бен», «дама червей», «туз треф» и т.п." << endl;
...
void  Case17()
{
	cout << "Case17.Дано целое число в диапазоне 10–40, определяющее количество учеб -\n\
...
void  Case18()
{
	cout << "Case18.Дано целое число в диапазоне 100–999.Вывести строку - описание\n\
данного числа, например: 256 — «двести пятьдесят шесть», 814 — «во -\n\
семьсот четырнадцать»." << endl;
	int a = 0;
